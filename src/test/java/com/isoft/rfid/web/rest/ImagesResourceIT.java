...
class ImagesResourceIT {
    ...
    @Test
    @Transactional
    void getAllImagesByImageLpIsEqualToSomething() throws Exception {
        // Initialize the database
        imagesRepository.saveAndFlush(images);

        // Get all the imagesList where imageLp equals to DEFAULT_IMAGE_LP
        defaultImagesShouldBeFound("imageLp.equals=" + DEFAULT_IMAGE_LP);

        // Get all the imagesList where imageLp equals to UPDATED_IMAGE_LP
        defaultImagesShouldNotBeFound("imageLp.equals=" + UPDATED_IMAGE_LP);
    }

    @Test
    @Transactional
    void getAllImagesByImageLpIsInShouldWork() throws Exception {
        // Initialize the database
        imagesRepository.saveAndFlush(images);

        // Get all the imagesList where imageLp in DEFAULT_IMAGE_LP or UPDATED_IMAGE_LP
        defaultImagesShouldBeFound("imageLp.in=" + DEFAULT_IMAGE_LP + "," + UPDATED_IMAGE_LP);

        // Get all the imagesList where imageLp equals to UPDATED_IMAGE_LP
        defaultImagesShouldNotBeFound("imageLp.in=" + UPDATED_IMAGE_LP);
    }

    @Test
    @Transactional
    void getAllImagesByImageLpIsNullOrNotNull() throws Exception {
        // Initialize the database
        imagesRepository.saveAndFlush(images);

        // Get all the imagesList where imageLp is not null
        defaultImagesShouldBeFound("imageLp.specified=true");

        // Get all the imagesList where imageLp is null
        defaultImagesShouldNotBeFound("imageLp.specified=false");
    }

    @Test
    @Transactional
    void getAllImagesByImageLpContainsSomething() throws Exception {
        // Initialize the database
        imagesRepository.saveAndFlush(images);

        // Get all the imagesList where imageLp contains DEFAULT_IMAGE_LP
        defaultImagesShouldBeFound("imageLp.contains=" + DEFAULT_IMAGE_LP);

        // Get all the imagesList where imageLp contains UPDATED_IMAGE_LP
        defaultImagesShouldNotBeFound("imageLp.contains=" + UPDATED_IMAGE_LP);
    }

    @Test
    @Transactional
    void getAllImagesByImageLpNotContainsSomething() throws Exception {
        // Initialize the database
        imagesRepository.saveAndFlush(images);

        // Get all the imagesList where imageLp does not contain DEFAULT_IMAGE_LP
        defaultImagesShouldNotBeFound("imageLp.doesNotContain=" + DEFAULT_IMAGE_LP);

        // Get all the imagesList where imageLp does not contain UPDATED_IMAGE_LP
        defaultImagesShouldBeFound("imageLp.doesNotContain=" + UPDATED_IMAGE_LP);
    }
    ...
    void searchImages() throws Exception {
        // Initialize the database
        images = imagesRepository.saveAndFlush(images);
        imagesSearchRepository.save(images);
