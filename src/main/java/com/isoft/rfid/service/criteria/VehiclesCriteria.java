...
/**
 * Criteria class for the {@link com.isoft.rfid.domain.Vehicles} entity. This class is used
 * in {@link com.isoft.rfid.web.rest.VehiclesResource} to receive all the possible filtering options from
...
public class VehiclesCriteria implements Serializable, Criteria {
    ...
    public VehiclesCriteria(VehiclesCriteria other) {
    ...
    @Override
    public VehiclesCriteria copy() {
        return new VehiclesCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final VehiclesCriteria that = (VehiclesCriteria) o;
        return (
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, guid, plate, anpr, rfid, dataStatus, gantry, lane, kph, ambush, direction, vehicle, status, distinct);
    }

    // prettier-ignore
    @Override
    public String toString() {
        return "VehiclesCriteria{" +
            (id != null ? "id=" + id + ", " : "") +
            (guid != null ? "guid=" + guid + ", " : "") +
