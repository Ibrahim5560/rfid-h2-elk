...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VEHICLES_LIST actions', async () => {
    ...
    it('dispatches SEARCH_VEHICLES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_VEHICLES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_VEHICLES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_VEHICLES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_VEHICLES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_VEHICLES actions', async () => {
      const expectedActions = [
        {
