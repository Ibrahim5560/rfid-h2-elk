...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GANTRY_LIST actions', async () => {
    ...
    it('dispatches SEARCH_GANTRIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_GANTRY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_GANTRY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_GANTRY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_GANTRY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_GANTRY actions', async () => {
      const expectedActions = [
        {
