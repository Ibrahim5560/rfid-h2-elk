...
import { searchEntities, getEntities } from './gantry.reducer';
  ...
  return (
    <div>
      <h2 id="gantry-heading" data-cy="GantryHeading">
        <Translate contentKey="rfidh2ElkApp.gantry.home.title">Gantries</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="rfidh2ElkApp.gantry.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/gantry/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="rfidh2ElkApp.gantry.home.createLabel">Create new Gantry</Translate>
          </Link>
        </div>
      </h2>
      <Row>
            ...
            <FormGroup>
              <InputGroup>
                <Input
                  ...
                  placeholder={translate('rfidh2ElkApp.gantry.home.search')}
                />
        ...
        {gantryList && gantryList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="rfidh2ElkApp.gantry.id">ID</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('guid')}>
                  <Translate contentKey="rfidh2ElkApp.gantry.guid">Guid</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('nameEn')}>
                  <Translate contentKey="rfidh2ElkApp.gantry.nameEn">Name En</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('nameAr')}>
                  <Translate contentKey="rfidh2ElkApp.gantry.nameAr">Name Ar</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('status')}>
                  <Translate contentKey="rfidh2ElkApp.gantry.status">Status</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('code')}>
                  <Translate contentKey="rfidh2ElkApp.gantry.code">Code</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="rfidh2ElkApp.gantry.home.notFound">No Gantries found</Translate>
            </div>
          )
        )}
      </div>
