...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EVENTSIMAGES_LIST actions', async () => {
    ...
    it('dispatches SEARCH_EVENTSIMAGES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_EVENTSIMAGES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_EVENTSIMAGES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_EVENTSIMAGES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_EVENTSIMAGES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_EVENTSIMAGES actions', async () => {
      const expectedActions = [
        {
