    ...
    <Row>
      <Col md="8">
        <h2 data-cy="tasksDetailsHeading">
          <Translate contentKey="rfidh2ElkApp.tasks.detail.title">Tasks</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="nameEn">
              <Translate contentKey="rfidh2ElkApp.tasks.nameEn">Name En</Translate>
            </span>
          </dt>
          <dd>{tasksEntity.nameEn}</dd>
          <dt>
            <span id="nameAr">
              <Translate contentKey="rfidh2ElkApp.tasks.nameAr">Name Ar</Translate>
            </span>
          </dt>
          <dd>{tasksEntity.nameAr}</dd>
          <dt>
            <span id="status">
              <Translate contentKey="rfidh2ElkApp.tasks.status">Status</Translate>
            </span>
          </dt>
          <dd>{tasksEntity.status}</dd>
          <dt>
            <span id="code">
              <Translate contentKey="rfidh2ElkApp.tasks.code">Code</Translate>
            </span>
          </dt>
