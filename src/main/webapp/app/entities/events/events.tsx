            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('processingTime')}>
                  <Translate contentKey="rfidh2ElkApp.events.processingTime">Processing Time</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                ...
                <th className="hand" onClick={sort('threadRandNo')}>
                  <Translate contentKey="rfidh2ElkApp.events.threadRandNo">Thread Rand No</Translate> <FontAwesomeIcon icon="sort" />
                </th>
