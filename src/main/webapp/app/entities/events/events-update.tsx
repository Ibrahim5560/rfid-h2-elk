          ...
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                ...
                type="text"
              />
              <ValidatedField label={translate('rfidh2ElkApp.events.lane')} id="events-lane" name="lane" data-cy="lane" type="text" />
              <ValidatedField
              ...
              />
              <ValidatedField
                label={translate('rfidh2ElkApp.events.processingTime')}
                id="events-processingTime"
                name="processingTime"
              ...
              />
              <ValidatedField
                label={translate('rfidh2ElkApp.events.threadRandNo')}
                id="events-threadRandNo"
                name="threadRandNo"
