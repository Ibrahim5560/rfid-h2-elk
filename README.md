...
To build the final jar and optimize the rfidh2Elk application for production, run:
...
Then navigate to [http://localhost:9096](http://localhost:9096) in your browser.
